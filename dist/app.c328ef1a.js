...
var SearchYoutube = function SearchYoutube(initialVnode) {
  var searchQuery = "";
  var searchResults = [];
  var selectedVideoId;
  ...
  var search = function search(e) {
    ...
    _mithril.default.request({
      method: "GET",
      url: "https://www.googleapis.com/youtube/v3/search?key=".concat(_secrets.youtubeAPIKey, "&q=").concat(encodeURIComponent(searchQuery), "&part=snippet&maxResults=25&type=video")
    }).then(function (res) {
      searchResults = res.items;
    });
  };

  var onSaveSongToLibrary = function onSaveSongToLibrary() {
  ...
  return {
    view: function view(vnode) {
      return (0, _mithril.default)("div", [(0, _mithril.default)("form", {
        onsubmit: search
      }, [(0, _mithril.default)("label.label", "Search"), (0, _mithril.default)("input[type=text][placeholder=Search Youtube...]", {
        value: searchQuery,
        oninput: function oninput(e) {
          e.preventDefault();
          searchQuery = e.target.value;
        }
      }), (0, _mithril.default)("button.button[type=button]", {
        onclick: search
      }, "Search")]), (0, _mithril.default)("ol", searchResults.map(function (item) {
      ...
      })), selectedVideoId && (0, _mithril.default)("button", {
        onclick: onSaveSongToLibrary
      }, "Add to library"), (0, _mithril.default)("button", {
        onclick: function onclick() {
...
var _default = SearchYoutube;
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","../secrets":"secrets.js"}],"components/SearchSpotify.js":[function(require,module,exports) {
"use strict";
...
var SearchSpotify = function SearchSpotify(initialVnode) {
  var searchQuery = "";
  var searchResults = [];
  ...
  var search = function search(e) {
    ...
    _app.SS.emit("search", searchQuery, function (data) {
      searchResults = data;
  ...
  return {
    view: function view(vnode) {
      return (0, _mithril.default)("div", [(0, _mithril.default)("form", {
        onsubmit: search
      }, [(0, _mithril.default)("label.label", "Search"), (0, _mithril.default)("input[type=text][placeholder=Search Spotify...]", {
        value: searchQuery,
        oninput: function oninput(e) {
          e.preventDefault();
          searchQuery = e.target.value;
...
var _default = SearchSpotify;
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","../app":"app.js"}],"actions/playerActions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.prevSong = exports.nextSong = void 0;
...
var nextSong = function nextSong() {
  var _playerState = (0, _app.playerState)(),
      queue = _playerState.queue,
      position = _playerState.position;

  var nextPosition = position + 1 > queue.length - 1 ? 0 : position + 1;
  var nextSong = queue[nextPosition];
  (0, _app.playerState)(_objectSpread({}, (0, _app.playerState)(), {
...
var prevSong = function prevSong(player) {
  var _playerState2 = (0, _app.playerState)(),
      queue = _playerState2.queue,
      position = _playerState2.position;

  var nextPosition = position - 1 < 0 ? queue.length - 1 : position - 1;
  (0, _app.playerState)(_objectSpread({}, (0, _app.playerState)(), {
    position: nextPosition,
...
},{"../app":"app.js","mithril":"node_modules/mithril/index.js"}],"components/YoutubePlayer.js":[function(require,module,exports) {
"use strict";
...
var YoutubePlayer = function YoutubePlayer(initialVnode) {
  var player;
  ...
  var oncreate = function oncreate(vnode) {
    ...
    setInterval(function () {
      if (player && (0, _app.playerState)().currentSong.snippet) {
        (0, _app.playerState)(_objectSpread({}, (0, _app.playerState)(), {
  ...
  var onbeforeupdate = function onbeforeupdate(vnode, old) {
    var _playerState = (0, _app.playerState)(),
        currentSong = _playerState.currentSong;
  ...
  var onPlayerStateChange = function onPlayerStateChange(event) {
    if (event.data == YT.PlayerState.ENDED) {
      (0, _playerActions.nextSong)();
      player.loadVideoById((0, _app.playerState)().currentSong.id);
    }
  };
...
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","../actions/playerActions":"actions/playerActions.js","../app":"app.js"}],"components/SpotifyPlayer.js":[function(require,module,exports) {
"use strict";
...
var SpotifyPlayer = function SpotifyPlayer(initialVnode) {
  var player;
  var token;
  var deviceId;

  var spotifyPlay = function spotifyPlay() {
    return fetch("https://api.spotify.com/v1/me/player/play?device_id=".concat(deviceId), {
      method: "PUT",
      body: JSON.stringify({
        uris: [(0, _app.playerState)().currentSong.track.uri]
      }),
      headers: {
  ...
  var oninit = function oninit(vnode) {
    _app.SS.on("token", function (incomingToken) {
      if (!player) {
        ...
        window.onSpotifyWebPlaybackSDKReady = function () {
          player = new Spotify.Player({
            ...
            getOAuthToken: function getOAuthToken(cb) {
              return cb(incomingToken);
            }
          });
          player.addListener("player_state_changed", function (state) {
            if (state.paused && !(0, _app.playerState)().paused) {
  ...
  var onbeforeupdate = function onbeforeupdate(vnode, old) {
    var _playerState2 = (0, _app.playerState)(),
        currentSong = _playerState2.currentSong;
...
var _default = SpotifyPlayer;
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","../actions/playerActions":"actions/playerActions.js","../app":"app.js"}],"components/Player.js":[function(require,module,exports) {
"use strict";
...
var _SpotifyPlayer = _interopRequireDefault(require("./SpotifyPlayer"));

var _app = require("../app");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Player = function Player(initialVnode) {
  return {
    view: function view(vnode) {
      var _playerState = (0, _app.playerState)(),
          currentSong = _playerState.currentSong;

      return (0, _mithril.default)("div", [(0, _mithril.default)(_SpotifyPlayer.default, {
        id: currentSong.track ? currentSong.track.id : currentSong.id
      }), (0, _mithril.default)(_YoutubePlayer.default, {
        playerId: "main",
        id: currentSong._id
      })]);
    }
...
var _default = Player;
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","./YoutubePlayer":"components/YoutubePlayer.js","./SpotifyPlayer":"components/SpotifyPlayer.js","../app":"app.js"}],"components/Library.js":[function(require,module,exports) {
"use strict";
...
var Library = function Library(initialVnode) {
  var onSongClick = function onSongClick(position) {
    var prevState = (0, _app.playerState)();
    (0, _app.playerState)(_objectSpread({}, prevState, {
  ...
  var onRemoveClick = function onRemoveClick(songItem) {
    _mithril.default.request({
      method: "PATCH",
  ...
  var oninit = function oninit() {
    _mithril.default.request({
      ...
      _app.SS.emit("library", null, function (data) {
        var prevState = (0, _app.playerState)();
        (0, _app.playerState)(_objectSpread({}, prevState, {
          library: [].concat(_toConsumableArray(prevState.library), _toConsumableArray(res), _toConsumableArray(data))
        }));
  ...
  return {
    ...
    view: function view(vnode) {
      var _vnode$attrs = vnode.attrs,
          currentSongId = _vnode$attrs.currentSongId,
          library = _vnode$attrs.library;
      return (0, _mithril.default)("div", [(0, _mithril.default)("h3", "library"), (0, _mithril.default)("div", {
        className: "library"
      }, library.map(function (item, index) {
        return (0, _mithril.default)("div", {
          className: "song-item",
          key: item.track ? item.track.id : item.id
        }, [(0, _mithril.default)("div", {
          className: (item.track ? currentSongId === item.track.id : currentSongId === item.id) ? "current-song" : "song-item",
          onclick: function onclick() {
            return onSongClick(index);
          }
        }, item.track ? item.track.name : item.snippet.title), (0, _mithril.default)("button", {
...
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","../app":"app.js"}],"components/Queue.js":[function(require,module,exports) {
"use strict";
...
var Queue = function Queue(initialVnode) {
  var shuffleQueue = function shuffleQueue() {
    var state = (0, _app.playerState)();
    var nextQueue = shuffle(state.queue.slice(0));
    (0, _app.playerState)(_objectSpread({}, state, {
      queue: nextQueue
    }));
  };
  ...
  return {
    view: function view() {
      var _playerState = (0, _app.playerState)(),
          queue = _playerState.queue,
          currentSongId = _playerState.currentSongId;

      return [(0, _mithril.default)("div", [(0, _mithril.default)("h3", "queue"), (0, _mithril.default)("div", {
        className: "queue"
...
var _default = Queue;
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","../app":"app.js"}],"components/Progress.js":[function(require,module,exports) {
"use strict";
...
var Progress = function Progress(initialVnode) {
  return {
    view: function view(vnode) {
      var _playerState = (0, _app.playerState)(),
      ...
      return (0, _mithril.default)("div", {
        ...
        style: {
          ...
          width: currentTime && duration ? "".concat(currentTime / duration * 100, "%") : "0px",
          height: "20px"
        }
      });
    }
...
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","../app":"app.js"}],"components/MainView.js":[function(require,module,exports) {
"use strict";
...
var MainView = function MainView(initialVnode) {
  var goToYoutubeSearch = function goToYoutubeSearch() {
    return _mithril.default.route.set("/search/youtube");
  };

  var goToSpotifySearch = function goToSpotifySearch() {
    return _mithril.default.route.set("/search/spotify");
  };
  ...
  return {
    view: function view(vnode) {
      var _playerState = (0, _app.playerState)(),
          currentSong = _playerState.currentSong,
          library = _playerState.library;

      return (0, _mithril.default)("div", {
        className: "main-view"
      }, [(0, _mithril.default)(_Library.default, {
        library: library,
        currentSongId: currentSong.track ? currentSong.track.id : currentSong.id
      }), (0, _mithril.default)(_Queue.default, {
        currentSongId: currentSong.track ? currentSong.track.id : currentSong.id
      }), (0, _mithril.default)(_Progress.default), (0, _mithril.default)(_Player.default), (0, _mithril.default)("button", {
        onclick: goToYoutubeSearch
      }, "Search Youtube"), (0, _mithril.default)("button", {
        onclick: goToSpotifySearch
      }, "Search Spotify")]);
    }
  };
};
...
exports.default = _default;
},{"mithril":"node_modules/mithril/index.js","./Player":"components/Player.js","./Library":"components/Library.js","./Queue":"components/Queue.js","./Progress":"components/Progress.js","../app":"app.js"}],"node_modules/mithril/stream/stream.js":[function(require,module,exports) {
/* eslint-disable */
;(function() {
"use strict"
/* eslint-enable */
...
},{"./stream/stream":"node_modules/mithril/stream/stream.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"cssBaseline.css":[function(require,module,exports) {
...
exports.playerState = exports.SS = void 0;

var _mithril = _interopRequireDefault(require("mithril"));

var _SearchYoutube = _interopRequireDefault(require("./components/SearchYoutube"));

var _SearchSpotify = _interopRequireDefault(require("./components/SearchSpotify"));
...
var SS = (0, _socket.default)(isDev ? "http://localhost:5000/spotify" : "https://luna.jaydanhoward.com/spotify");
exports.SS = SS;
var playerState = (0, _stream.default)({
  paused: false,
  library: [],
  queue: [],
  position: 0,
...
_mithril.default.route(document.body, "/main", {
  "/main": _MainView.default,
  "/search/youtube": _SearchYoutube.default,
  "/search/spotify": _SearchSpotify.default
});
},{"mithril":"node_modules/mithril/index.js","./components/SearchYoutube":"components/SearchYoutube.js","./components/SearchSpotify":"components/SearchSpotify.js","./components/MainView":"components/MainView.js","mithril/stream":"node_modules/mithril/stream.js","./cssBaseline.css":"cssBaseline.css","./app.css":"app.css","socket.io-client":"node_modules/socket.io-client/lib/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
